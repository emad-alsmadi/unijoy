    ...
    return (
        <section className="relative h-auto min-h-screen md:h-[80vh] overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 right-0 z-[5] pointer-events-none">
                <svg viewBox="0 0 1440 150" xmlns="http://www.w3.org/2000/svg" className="w-full h-[120px] md:h-[150px]">
                    <path d="M0,96 C240,144 480,0 720,24 C960,48 1200,168 1440,120 L1440,180 L0,180 Z" fill="url(#grad)" opacity="0.9" />
                    <defs>
