...
const AllEventsPage = ({ className })=>{
    ...
    const filteredEvents = (__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$events$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["events"] || []).filter((eve)=>{
        ...
        const matchesFilter = activeFilter === 'all' || activeFilter === 'upcoming' || activeFilter === 'past' || activeFilter === 'university' && eve.location.includes("University") || activeFilter === 'price';
...
//# sourceMappingURL=_12b1a30e._.js.map