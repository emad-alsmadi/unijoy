...
;
;
function RegisterConfirmationDialog({ open, onOpenChange, title = 'Confirm Unregister ', description = 'Are you sure you want to Register this event? This action cannot be undone.', confirmLabel = 'Register  Permanently', cancelLabel = 'Cancel', onConfirm, event }) {
...
const AllEventsPage = ({ className })=>{
    ...
    const [nameButton, setNameButton] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('Register');
    ...
    const confirmRegister = async ()=>{
        ...
        try {
            const res = await fetch(`http://localhost:8080/users/me/events/${selectedEvent._id}/confirm`, {
                method: 'POST',
                headers: {
                    Authorization: `Bearer ${token}`,
                    'Content-Type': 'application/json'
            ...
            setEvents((prev)=>prev.filter((user)=>user._id !== selectedEvent._id));
        } catch (error) {
            toast({
                title: 'Error',
                description: error?.message || 'An unexpected error occurred.',
...
//# sourceMappingURL=_74e03b58._.js.map