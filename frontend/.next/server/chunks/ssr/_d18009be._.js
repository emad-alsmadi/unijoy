...
"[project]/app/auth/new-password/page.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function NewPasswordPage() {
    ...
    const handleSubmit = async (e)=>{
        ...
        setLoading(true);
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/auth/new-password`, {
                method: 'POST',
                headers: {
...
//# sourceMappingURL=_d18009be._.js.map