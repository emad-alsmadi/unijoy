...
const HostDashboard = ()=>{
    ...
    const handleDelete = async (_id)=>{
        ...
        try {
            const response = await fetch(`http://localhost:8080/host/events?${_id}`, {
                method: 'DELETE',
                credentials: 'include'
            });
            const data = await response.json();
            ...
            const updateEvent = events?.filter((b)=>b._id !== selectedEvent._id);
...
//# sourceMappingURL=_66903bd4._.js.map