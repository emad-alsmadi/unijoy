...
function AddHallDialog({ open, onClose, onSuccess }) {
    ...
    const handleSubmit = async ()=>{
        setLoading(true);
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/halls`, {
                method: "POST",
                credentials: "include",
                headers: {
...
function AdminHallsPage() {
    ...
    const handleDelete = async ()=>{
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/halls/${selectedHall.id}`, {
                method: "DELETE",
                credentials: "include"
            });
...
//# sourceMappingURL=_4241827a._.js.map