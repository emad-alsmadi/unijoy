...
const AllEventsPage = ({ className })=>{
    ...
    const filteredEvents = (__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$events$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["events"] || []).filter((event)=>{
        ...
        const matchesFilter = activeFilter === 'all' || activeFilter === 'active' && new Date(event.date) > new Date() || activeFilter === 'latest' && new Date(event.date) <= new Date() || activeFilter === 'weekdays' && event.date === 'pending' || activeFilter === 'university' && event.location.includes("University") || activeFilter === 'price' && Array.isArray(event.prices);
...
//# sourceMappingURL=_be146472._.js.map