...
const AllEventsPage = ({ className })=>{
    ...
    const fetchEvents = async ()=>{
        ...
        try {
            const res = await fetch(`http://localhost:8080/host/events?page=${currentPage}&perPage=${eventsPerPage}&type=${filterType}`, {
                method: 'GET',
                headers: {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__e4cd92d7._.js.map