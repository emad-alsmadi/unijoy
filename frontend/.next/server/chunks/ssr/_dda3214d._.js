...
const HostDashboard = ()=>{
    ...
    // تصفية الأحداث
    const filteredEvents = (__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$events$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["events"] || []).filter((event)=>activeFilter === 'all' && event.title.toLowerCase().includes(debouncedQuery.toLowerCase()));
    ...
    const stats = {
        ...
        totalAttendees: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$events$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["events"]?.reduce((sum, e)=>sum + (attendees || 0), 0) || 0,
        totalRevenue: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$events$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["events"]?.reduce((sum, e)=>sum + (revenue || 0), 0) || 0
    };
    // حالة التحميل
...
//# sourceMappingURL=_dda3214d._.js.map