...
const HostDashboard = ()=>{
    ...
    const response = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["NextResponse"].next();
    response.cookies.set('role', 'host');
    ...
    const filteredEvents = (__TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$events$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["events"] || []).filter((event)=>{
        ...
        const matchesFilter = activeFilter === 'all' || activeFilter === 'active' && new Date(event.date) > new Date() || activeFilter === 'past' && new Date(event.date) <= new Date() || activeFilter === 'pending' && event.status === 'pending' || activeFilter === 'approved' && event.status === 'approved' || activeFilter === 'rejected' && event.status === 'rejected';
    ...
    // إحصائيات الأحداث
    const stats = {
        totalEvents: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$events$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["events"]?.length || 0,
        upcomingEvents: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$events$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["events"]?.filter((e)=>new Date(e.date) > new Date()).length || 0,
        pendingEvents: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$events$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["events"]?.filter((e)=>e.status === 'pending').length || 0,
        totalAttendees: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$events$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["events"]?.reduce((sum, e)=>sum + (e.attendees || 0), 0) || 0,
        totalRevenue: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$events$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["events"]?.reduce((sum, e)=>sum + (e.revenue || 0), 0) || 0
    };
    // حالة التحميل
    if (isLoading) {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$Card$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["CardContent"], {
                                                ...
                                                children: [
                                                    ...
                                                    event.revenue && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                        className: "flex items-center gap-2 text-sm text-gray-600",
                                                        children: [
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                Array.from({
                                    ...
                                    const pageNumber = totalPages <= 5 ? index + 1 : currentPage <= 3 ? index + 1 : currentPage >= totalPages - 2 ? totalPages - 4 + index : currentPage - 2 + index;
                                    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$components$2f$ui$2f$button$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Button"], {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__16c80947._.js.map