...
const UserDashboard = ()=>{
    ...
    const fetchEvents = async ()=>{
        ...
        try {
            const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL}/users/me/registered-events?type=${type}&page=${currentPage}&perPage=${eventsPerPage}`, {
                method: 'GET',
                credentials: 'include'
            });
    ...
    const filteredEvents = events.filter((event)=>event.title.toLowerCase().includes(debouncedQuery.toLowerCase()));
                    ...
                    children: [
                        ...
                        Array.from({
                            length: totalPages
                                ...
                                ${currentPage === index + 1 ? 'bg-purple-600 text-white' : 'text-purple-500 hover:bg-purple-100'}`,
                                children: index + 1
                            }, index, false, {
                                fileName: "[project]/app/(auth)/user/dashboard/page.tsx",
                                lineNumber: 210,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__99b8b8fb._.js.map