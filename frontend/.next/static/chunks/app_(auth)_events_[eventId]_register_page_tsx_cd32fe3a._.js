...
"[project]/app/(auth)/events/[eventId]/register/page.tsx [app-client] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
function RegisterPage() {
    ...
    const onSubmit = async (values)=>{
        try {
            const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL}/users/me/events/${eventId}/register`, {
                method: 'POST',
                headers: {
...
_s(RegisterPage, "Eob8+9ex6iyKHmAYJZmLdn1P2mI=", false, function() {
    return [
...
//# sourceMappingURL=app_%28auth%29_events_%5BeventId%5D_register_page_tsx_cd32fe3a._.js.map