...
const AllEventsPage = ({ className })=>{
    ...
    const kpis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AllEventsPage.useMemo[kpis]": ()=>{
            const total = events.length;
            const approved = events.filter({
                "AllEventsPage.useMemo[kpis]": (e)=>e.status === 'approved'
            }["AllEventsPage.useMemo[kpis]"]).length;
            const rejected = events.filter({
                "AllEventsPage.useMemo[kpis]": (e)=>e.status === 'rejected'
            }["AllEventsPage.useMemo[kpis]"]).length;
            const pending = events.filter({
                "AllEventsPage.useMemo[kpis]": (e)=>e.status === 'pending'
            }["AllEventsPage.useMemo[kpis]"]).length;
            return [
                {
                    title: 'Approved',
    ...
    const barData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AllEventsPage.useMemo[barData]": ()=>(events || []).map({
                "AllEventsPage.useMemo[barData]": (e)=>({
                        name: e.title,
                        value: Array.isArray(e.registeredUsers) ? e.registeredUsers.length : 0
                    })
            }["AllEventsPage.useMemo[barData]"])
    }["AllEventsPage.useMemo[barData]"], [
        events
    ]);
    // Pie: status distribution
    const roleSlices = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AllEventsPage.useMemo[roleSlices]": ()=>{
            return [
                {
                    label: 'Approved',
                    value: events.filter({
                        "AllEventsPage.useMemo[roleSlices]": (e)=>e.status === 'approved'
                    }["AllEventsPage.useMemo[roleSlices]"]).length,
                    color: '#16a34a'
                },
                {
                    label: 'Pending',
                    value: events.filter({
                        "AllEventsPage.useMemo[roleSlices]": (e)=>e.status === 'pending'
                    }["AllEventsPage.useMemo[roleSlices]"]).length,
                    color: '#f59e0b'
                },
                {
                    label: 'Rejected',
                    value: events.filter({
                        "AllEventsPage.useMemo[roleSlices]": (e)=>e.status === 'rejected'
                    }["AllEventsPage.useMemo[roleSlices]"]).length,
                    color: '#ef4444'
                }
            ];
    ...
    const trendData = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "AllEventsPage.useMemo[trendData]": ()=>{
            const map = new Map();
            (events || []).forEach({
                "AllEventsPage.useMemo[trendData]": (e)=>{
            ...
            const entries = Array.from(map.entries()).sort({
                "AllEventsPage.useMemo[trendData].entries": (a, b)=>a[0] < b[0] ? -1 : 1
            }["AllEventsPage.useMemo[trendData].entries"]);
            return entries.map({
                "AllEventsPage.useMemo[trendData]": ([ym, count])=>{
                    const [y, m] = ym.split('-');
...
_s(AllEventsPage, "rhBYV3CCnlUIkwUUCQ3L4cZgbec=", false, function() {
    return [
...
//# sourceMappingURL=_e476f3c5._.js.map