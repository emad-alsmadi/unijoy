        ...
        "AuthProvider.useEffect": ()=>{
            ...
            const verifyToken = {
                "AuthProvider.useEffect.verifyToken": async ()=>{
                    setIsLoading(true);
                    try {
                        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL}/events`, {
                            method: 'GET',
                            credentials: 'include'
                        });
                        if (response.ok) {
                            ...
                            }["AuthProvider.useEffect.verifyToken"], 500);
...
_s(AuthProvider, "TMnrANfrz2G5Egma0vkdh4HZuJw=", false, function() {
    return [
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "Header.useEffect": ()=>{
            const fetchProfileInfo = {
                "Header.useEffect.fetchProfileInfo": async ()=>{
                    try {
                        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL}/profile`, {
                            method: 'GET',
                            headers: {
            ...
            }["Header.useEffect.fetchProfileInfo"];
        //fetchProfileInfo();
        }
    }["Header.useEffect"], [
        profileInfo
...
_s(Header, "fzs4Gp8aIQW6f515tTqfwXfAdGY=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$context$2f$AuthContext$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAuth"],
        __TURBOPACK__imported__module__$5b$project$5d2f$hooks$2f$use$2d$toast$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useToast"]
    ];
...
//# sourceMappingURL=_ff3e5aab._.js.map