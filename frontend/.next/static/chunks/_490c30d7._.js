...
const HostDashboard = ()=>{
    ...
    const [eventPerPage] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(6); // عدد الأحداث في كل صفحة
    ...
    const fetchEvents = async ()=>{
        ...
        try {
            ...
            const response = await fetch(`http://localhost:8080/host/events?page=${currentPage}&perPage=${eventPerPage}&type=${filterType}`, {
                method: 'GET',
                headers: {
                    Authorization: `Bearer ${token}`,
                    'Content-Type': 'application/json'
...
_s(HostDashboard, "wlSLEwXk9UFyItgQsDKOpujonOw=", false, function() {
    return [
...
//# sourceMappingURL=_490c30d7._.js.map