...
const UserDashboard = ()=>{
    ...
    const fetchEvents = async ()=>{
        ...
        try {
            const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL}/users/me/registered-events?type=${type}&page=${currentPage}&perPage=${eventsPerPage}`, {
                method: 'GET',
                credentials: 'include'
            });
    ...
    const filteredEvents = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$events$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["events"].filter((event)=>event.title.toLowerCase().includes(debouncedQuery.toLowerCase()));
...
_s(UserDashboard, "Bm8RhwmP5VxejFwKhdMBcxH48o0=", false, function() {
    return [
...
//# sourceMappingURL=_73ea5c06._.js.map