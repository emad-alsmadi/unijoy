...
const HostDashboard = ()=>{
    ...
    const stats = {
        ...
        pendingEvents: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$events$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["events"]?.filter((e)=>e.status === 'pending').length || 0,
        totalAttendees: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$events$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["events"]?.reduce((sum, e)=>sum + (e.attendees || 0), 0) || 0,
        totalRevenue: __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$events$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["events"]?.reduce((sum, e)=>sum + (e.revenue || 0), 0) || 0
    };
    // state Loading
    if (loading) {
    ...
    const handleDelete = async ()=>{
        ...
        try {
            ...
            const updateEvent = __TURBOPACK__imported__module__$5b$project$5d2f$constants$2f$events$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["events"].filter((b)=>b.id !== selectedEvent.id);
...
_s(HostDashboard, "iDfuN/kHkt1Vd7Tmd36XXGsX+44=", false, function() {
    return [
...
//# sourceMappingURL=_02defff1._.js.map