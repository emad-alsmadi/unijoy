...
const getServerSideProps = async ()=>{
    try {
        // في الإنتاج استبدل هذا بعنوان API الحقيقي
        const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.API_URL}/events`);
...
const HostDashboard = ({ initialEvents, error })=>{
    _s();
    // إدارة حالة البيانات مع SWR
    const { data: events, error: swrError, mutate } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"])('/api/events', fetcher, {
    ...
    const [debouncedQuery] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$use$2d$debounce$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDebouncedValue"])(searchQuery, 300);
    ...
    // تصفية الأحداث
    const filteredEvents = (events || []).filter((event)=>(activeFilter === 'all' || event.status === activeFilter) && event.title.toLowerCase().includes(debouncedQuery.toLowerCase()));
    // Pagination
    ...
    const stats = {
        ...
        totalAttendees: events?.reduce((sum, e)=>sum + (e.attendees || 0), 0) || 0,
        totalRevenue: events?.reduce((sum, e)=>sum + (e.revenue || 0), 0) || 0
    };
    // معالجة الأخطاء
    if (error || swrError) {
...
_s(HostDashboard, "AWShROnKhBms6cQT+hhski4NX3s=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$swr$2f$dist$2f$index$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"],
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$use$2d$debounce$2f$dist$2f$index$2e$module$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDebouncedValue"]
    ];
});
_c = HostDashboard;
...
//# sourceMappingURL=_ee16a989._.js.map