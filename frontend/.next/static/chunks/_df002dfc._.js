...
const AllEventsPage = ({ className })=>{
    ...
    const onApprove = ()=>{
        ...
        handleStatusChange({
            url: `${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL}/api/events/${selectedEvent.id}/status`,
            method: "PATCH",
            body: {
                status: "approved"
            },
...
_s(AllEventsPage, "RJzx5L3c2wdAfXhBBzx+OD4WJA0=", false, function() {
    return [
...
//# sourceMappingURL=_df002dfc._.js.map