...
;
;
const organizerSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    organizerType: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].enum([
        "company",
        "university"
    ]),
    companyName: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().min(3, "Name must contain at least 3 characters"),
    contactPerson: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().min(3, "Name must contain at least 3 characters"),
    ...
    phone: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().regex(/^\d{10}$/, "Phone must be 10 digits"),
    address: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().min(5, "Address must contain at least 5 characters"),
    website: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().url("Invalid website URL"),
    document: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].instanceof(File, {
...
const OrganizerRegisterForm = ()=>{
    ...
    const onSubmit = async (values)=>{
        ...
        try {
            ...
            // 1. إنشاء FormData لإرسال البيانات (خاصة الملف)
            ...
            // 2. إضافة حقل role لتحديد نوع المستخدم
            formData.append('role', 'host'); // تحديد أن هذا التسجيل للمضيفين
            const response = await fetch(`${API_URL}/api/register/organizer`, {
                method: "POST",
                body: formData,
                credentials: "include"
            });
            if (response.ok) {
                ...
                // 3. توجيه المستخدم بعد التسجيل الناجح
                setTimeout(()=>{
...
_s(OrganizerRegisterForm, "wQ33kwrTBEQ/cEd0llnXjEEAvrw=", false, function() {
    return [
...
//# sourceMappingURL=_0f79291b._.js.map