...
const fetchEvent = async (setLoading, token, eventId, role, toast // نوع toast الصحيح
    ...
    try {
        const res = await fetch(`http://localhost:8080/${role}/events/${eventId}`, {
            method: 'GET',
            headers: {
...
const EventDetailsPage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "EventDetailsPage.useEffect": ()=>{
            if (token) {
                (0, __TURBOPACK__imported__module__$5b$project$5d2f$api$2f$events$2f$event$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["fetchEvent"])(setLoading, token, eventId, "admin", toast).then({
...
//# sourceMappingURL=_4b3a73b4._.js.map