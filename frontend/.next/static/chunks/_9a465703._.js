...
const AdminUsersPage = ()=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AdminUsersPage.useEffect": ()=>{
            ...
            const mockUsers = Array.from({
                ...
                "AdminUsersPage.useEffect.mockUsers": (_, i)=>({
                        id: `user-${i}`,
                        name: `User ${i + 1}`,
            ...
            }["AdminUsersPage.useEffect.mockUsers"]);
            setUsers(mockUsers);
        ...
        "AdminUsersPage.useEffect": ()=>{
            const fetchUsers = {
                "AdminUsersPage.useEffect.fetchUsers": async ()=>{
                    try {
                        const response = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL}/admin/users`, {
                            method: 'GET',
                            credentials: 'include',
                            headers: {
    ...
    const handleToggleStatus = async (user, newStatus)=>{
        try {
            const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL}/admin/hosts/${user.id}/status`, {
                method: 'PATCH',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json'
    ...
    const confirmDelete = async ()=>{
        ...
        try {
            const res = await fetch(`${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL}/admin/users/${selectedUser.id}`, {
                method: 'DELETE',
                credentials: 'include',
                headers: {
                    'Content-Type': 'application/json'
...
_s(AdminUsersPage, "OTrkiZL0hXn+ecWAUpFHVgzIgYU=", false, function() {
    return [
...
//# sourceMappingURL=_9a465703._.js.map