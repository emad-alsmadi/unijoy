...
const AllEventsPage = ({ className })=>{
    ...
    const onApprove = ()=>{
        ...
        handleStatusChange({
            url: `${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL}/api/admin/events/${selectedEvent.id}/approve`,
            method: 'PATCH',
            body: {
                status: 'approve'
            },
    ...
    const onReject = ()=>{
        if (!selectedEvent) return;
        handleStatusChange({
            url: `${__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$build$2f$polyfills$2f$process$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].env.NEXT_PUBLIC_API_URL}/api/admin/events/${selectedEvent.id}/reject`,
            method: 'PATCH',
            body: {
                status: 'reject'
            },
...
_s(AllEventsPage, "FrKQq8+a0bZVfO2rVX6vSj24gHA=", false, function() {
    return [
...
//# sourceMappingURL=_9c2e4726._.js.map