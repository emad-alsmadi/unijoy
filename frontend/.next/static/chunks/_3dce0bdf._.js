...
function HostCategoriesPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "HostCategoriesPage.useEffect": ()=>{
            ...
            if (search.trim()) {
                temp = temp.filter({
                    "HostCategoriesPage.useEffect": (c)=>c.name.toLowerCase().includes(search.toLowerCase()) || c.description.toLowerCase().includes(search.toLowerCase())
                }["HostCategoriesPage.useEffect"]);
            }
            setFiltered(temp);
        }
...
_s(HostCategoriesPage, "cN/aNagrnQIS5ilm5UBNKkjyzWM=", false, function() {
    return [
...
//# sourceMappingURL=_3dce0bdf._.js.map