...
const loginSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].object({
    ...
    password: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["z"].string().min(8, "كلمة المرور يجب أن تكون 8 أحرف على الأقل")
});
const LoginForm = ()=>{
    _s();
...
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
 ...
 // import { Building2, Mail, Phone, MapPin, Link, FileText, ArrowRight } from "lucide-react";
 // import { Select, SelectContent, SelectItem, SelectTrigger, SelectValue } from "@/components/ui/select";
 // const organizerSchema = z.object({
 //     organizerType: z.enum(["company", "university"]),
 //     companyName: z.string().min(3, "اسم المؤسسة يجب أن يحتوي على 3 أحرف على الأقل"),
 //     contactPerson: z.string().min(3, "اسم المسؤول يجب أن يحتوي على 3 أحرف على الأقل"),
 ...
 //     document: z.instanceof(File, { message: "يجب رفع وثيقة التفويض" })
 // });
 // export const OrganizerRegisterForm = () => {
 ...
 //                 <h1 className="text-3xl font-bold text-gray-900">تسجيل جهة منظمة</h1>
 //                 <p className="text-gray-600 mt-2">للجامعات والشركات والمؤسسات المعتمدة</p>
 //             </div>
 //             <Form {...form}>
 ...
 //                         render={({ field }) => (
 //                             <FormItem>
 //                                 <FormLabel>نوع الجهة المنظمة</FormLabel>
 ...
 //                                     </FormControl>
 //                                     <SelectContent>
 //                                         <SelectItem value="company">شركة خارجية</SelectItem>
 //                                         <SelectItem value="university">جهة جامعية</SelectItem>
 //                                     </SelectContent>
 //                                 </Select>
 //                                 <FormMessage />
 //                             </FormItem>
 ...
 //                                 <FormItem>
 //                                     <FormLabel>
 //                                         {form.watch("organizerType") === "company"
 //                                             ? "اسم الشركة"
 //                                             : "اسم القسم/الكلية"}
 //                                     </FormLabel>
 //                                     <FormControl>
 ...
 //                                 <FormControl>
 //                                     <Input
 //                                         placeholder="دمشق، شارع الرئيسية"
 //                                         {...field}
 //                                         className="rtl:text-right"
 ...
 //                                         {...field}
 //                                         className="rtl:text-right"
 //                                         startIcon={<Link className="h-5 w-5" />}
 //                                     />
 //                                 </FormControl>
 //                                 <FormMessage />
 //                             </FormItem>
 ...
 //                         render={({ field }) => (
 //                             <FormItem>
 //                                 <FormLabel>وثيقة التفويض</FormLabel>
 //                                 <FormControl>
 ...
 //                             إتمام التسجيل <ArrowRight className="h-4 w-4 mr-2" />
 //                         </Button>
 //                     </motion.div><div className="mt-8 border-t pt-6">
...
//# sourceMappingURL=_64565d94._.js.map